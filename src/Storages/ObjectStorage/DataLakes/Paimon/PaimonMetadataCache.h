...
/// Thread-safe metadata cache for Paimon (OPTIONAL).
/// Caches parsed manifest lists and manifest files.
/// Similar to IcebergMetadataFilesCache in design.
///
...
public:
    ...
    /// Generate cache key: table_path + file_path
